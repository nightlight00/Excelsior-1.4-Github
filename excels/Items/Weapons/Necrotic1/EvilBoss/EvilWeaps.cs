...
namespace excels.Items.Weapons.Necrotic1.EvilBoss
{
	...
	public class CrimsonHeart : clericHealProj
    {
        ...
        public override void AI()
        {
            ...
            {
				HealDistance(Main.LocalPlayer, Main.player[Projectile.owner], 32, -1);
        ...
        {
			int healAmount = (int)(target.statLifeMax2 * (0.025f + (healer.GetModPlayer<excelPlayer>().healBonus * 0.005f)));
	...
	public class ShadowOrb : clericHealProj
	{
		...
		public override void AI()
		{
			...
			{
				HealDistance(Main.LocalPlayer, Main.player[Projectile.owner], 32, 6);
				Projectile.velocity *= 0.95f;
			}
		}
