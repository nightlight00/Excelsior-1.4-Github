...
namespace excels.Items.WeaponHeal.Generic
{
	...
	public class HealingBolt : clericHealProj
    {
        ...
        public override void AI()
        {
			...
			HealDistance(Main.LocalPlayer, Main.player[Projectile.owner], 10, (int)(2 + Projectile.ai[0]));
	...
	public class ThrownHealthPotion : clericHealProj
    {
        ...
        {
			HealDistance(Main.LocalPlayer, Main.player[Projectile.owner], 32, 30);
			for (var i = 0; i < 15; i++)
            {
	...
	public class SyringeThrown : clericHealProj
	{
		...
		public override void AI()
		{
			HealDistance(Main.LocalPlayer, Main.player[Projectile.owner], 12, 3, false);
			Projectile.rotation += MathHelper.ToRadians(Projectile.velocity.X);
			Projectile.ai[0]++;
