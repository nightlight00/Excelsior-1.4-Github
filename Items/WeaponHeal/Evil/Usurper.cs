...
namespace excels.Items.WeaponHeal.Evil
{
    internal class UsurperCross : ClericDamageItem
    {
        ...
        {
			Projectile.NewProjectile(source, position, velocity.RotatedBy(MathHelper.ToRadians(7)), type, damage, knockback, player.whoAmI);
			Projectile.NewProjectile(source, position, velocity.RotatedBy(MathHelper.ToRadians(-7)), type, damage, knockback, player.whoAmI);
			return false;
        }
	...
	//		Main.projFrames[Projectile.type] = 2;
        ...
        {
			int healAmount = (2 + (healer.GetModPlayer<excelPlayer>().healBonus / healBonusDivison)) / 2;
        ...
        public override void AI()
		{
			...
			HealDistance(Main.LocalPlayer, Main.player[Projectile.owner], 10, 2);
