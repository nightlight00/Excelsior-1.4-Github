...
namespace excels.Items.Weapons.Stellar
{
    ...
    public class StellarCommandShip : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                if (Main.myPlayer == Main.player[Projectile.owner].whoAmI && Main.mouseLeft && !player.mapFullScreen)
                {
    ...
    public class StarbornFragment : clericHealProj
    {
        ...
        public override void AI()
        {
            HealCollision(Main.LocalPlayer, Main.player[Projectile.owner], healAmount);
