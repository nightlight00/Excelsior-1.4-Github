    ...
    internal class StellarStarship : ModNPC
    {
        ...
        {           
            ...
            for (int k = 0; k < NPC.oldPos.Length; k++)
            {
                ...
                {
                    //NPC.oldPos[k]
                    Vector2 drawPos = NPC.oldPos[k] - new Vector2(0, 15) - Main.screenPosition;
        ...
        public override void PostDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor)
        {
            ...
            var offset = new Vector2(NPC.width / 2f, NPC.height / 2f);
            Vector2 origin = NPC.frame.Size() / 2f;
            Main.spriteBatch.Draw(texture, (NPC.position - new Vector2(0, 15) - Main.screenPosition) + offset, null, NPC.GetAlpha(new Color(155, 155, 155, 155)), NPC.rotation, origin, NPC.scale, SpriteEffects.None, 0);
        }
